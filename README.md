# picolog <sub><sup>v0.4.0</sup></sub>
**Tiny logging helper for use in the browser**

![logo](https://cdn.rawgit.com/download/picolog/0.4.0/picolog.png)
...
Because it uses native logging under the hood and it's [49 lines of code](https://cdn.rawgit.com/download/picolog/0.4.0/dist/picolog.umd.js) 
...
## Download
* [picolog.umd.js](https://cdn.rawgit.com/download/picolog/0.4.0/dist/picolog.umd.js) (~2kB, source)
* [picolog.min.js](https://cdn.rawgit.com/download/picolog/0.4.0/dist/picolog.min.js) (~1kB, minified)
* [picolog.min.js.map](https://cdn.rawgit.com/download/picolog/0.4.0/dist/picolog.min.js.map) (~2kB, debug map file)
...
```xml
<script src="https://cdn.rawgit.com/download/picolog/0.4.0/dist/picolog.min.js"></script>
```
